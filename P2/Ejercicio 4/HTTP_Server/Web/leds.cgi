...
# Here begin the 'checkbox' definitions. ES IMPORTANTE ENTENDER QUE los números indican la posicion de env y esta relacionado con el bit a '1' de P2
c b 6 <td><input type=checkbox name=red OnClick="submit();" %s>Red</td>
c b 5 <td><input type=checkbox name=green OnClick="submit();" %s>Green</td>
c b 4 <td><input type=checkbox name=blue OnClick="submit();" %s>Blue</td>
t <td width="5%"></td>
